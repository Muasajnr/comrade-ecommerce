...
$sql_orders = $conn->prepare("SELECT * FROM orders WHERE user_id = ?");
$sql_orders->bind_param("i", $user_id);
$sql_orders->execute();
$orders_result = $sql_orders->get_result();

// Fetch user account information if needed
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3">Buyer Dashboard</h1>
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <a class="cat-item d-block bg-light text-center rounded p-3" href="my-orders.php">
                            <div class="rounded p-4">
                                ...
                                <h6>My Orders</h6>
                                <span><?php echo $orders_result->num_rows; ?> Orders</span>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <a class="cat-item d-block bg-light text-center rounded p-3" href="my-account.php">
                            <div class="rounded p-4">
                                <div class="icon mb-3">
